...
if __name__ == '__main__':
    input_file = Path("/mnt/f/OneDrive/文档（科研）/脚本/Download/10-mtDNA/2-母系专用/example/output/正序等级.txt")
    output_file = Path("/mnt/f/OneDrive/文档（科研）/脚本/Download/10-mtDNA/2-母系专用/example/output/正序等级-补齐至下游.txt")
