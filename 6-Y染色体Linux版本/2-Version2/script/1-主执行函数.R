...
# setwd("I:/1_Projects2023/1YChromosome/17Y_ChromosomePPG_Pipeline/1Ancients/")
setwd("/mnt/f/OneDrive/文档（科研）/脚本/Download/10-mtDNA/6-Y染色体Linux版本/2-Version2/script")
# --- Input files ---
if (!exists("input_xlsx")) input_xlsx <- "../input/Table_Haplogroup.xlsx"
if (!exists("meta_csv"))   meta_csv   <- "../conf/Group.csv"    # optional
if (!exists("ystr_csv"))   ystr_csv   <- "YSTR_table.csv"             # optional
if (!exists("haplogroup_hierarchy_csv")) haplogroup_hierarchy_csv <- "../input/Haplogroup_Hierarchy.csv"  # NEW: alternative to haplogroup_full truncation
